...
set csv_out_file=symmIterSingle-batch.csv
...
java -ea -Xmx12096M -jar jartools/GBGBatch.jar RubiksCube 1 TCL4-p13-ET16-3000k-120-7t-stub.agt.zip 3 300 experim_04_00.csv 3x3x3 STICKER2 QTM
java -ea -Xmx12096M -jar jartools/GBGBatch.jar RubiksCube 1 TCL4-p13-ET16-3000k-120-7t-nsym08-stub.agt.zip 3 300 experim_04_08.csv 3x3x3 STICKER2 QTM
java -ea -Xmx12096M -jar jartools/GBGBatch.jar RubiksCube 1 TCL4-p13-ET16-3000k-120-7t-nsym16-stub.agt.zip 3 300 experim_04_16.csv 3x3x3 STICKER2 QTM
java -ea -Xmx12096M -jar jartools/GBGBatch.jar RubiksCube 1 TCL4-p13-ET16-3000k-120-7t-nsym24-stub.agt.zip 3 300 experim_04_24.csv 3x3x3 STICKER2 QTM
