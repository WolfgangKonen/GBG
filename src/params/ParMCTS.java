...
public class ParMCTS implements Serializable {
    ...
    public static double DEFAULT_K = Math.round(1000*Math.sqrt(2))/1000.0;
	/**
	 ...
	 */
    public static double DEFAULT_EPSILONGREEDY = 0.05;
    public static int DEFAULT_VERBOSITY = 0;
    public static int DEFAULT_SELECT_MODE = 0;	// 0:[UCT], 1:[eps-greedy], 2:[roulette wheel]
