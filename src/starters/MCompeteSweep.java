...
public class MCompeteSweep {
     ...
     * The Edax depth levels are coded in array {@code depthArr}.
     * If {@code iterMWrap==0}, evaluate only the base agent.
     * <p>
     ...
     *     <li> train csv file {@code <agtBase>_EX<e>_<i+k>.csv}
     * </ul>
