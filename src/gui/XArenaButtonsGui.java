	...
	private void initGui() {
		...
		switch (gName) {
			...
			case "RubiksCube" -> {
				...
				gui_agent_list[gui_agent_list.length - 1] = "DAVI4";
			}
			case "Othello" -> {
			...
			case "BlackJack" -> {
				gui_agent_list[gui_agent_list.length - 1] = "BSBJA";
			}
		}
		...
		for (int n=numPlayers-1; n>=0; n--) {
			...
			if (m_arena.getGameBoard().getDefaultStartState(null).isDeterministicGame()) { // if changes are applied to this if
