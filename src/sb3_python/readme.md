...
## Installation
First, install all necessary requirements. It is recommended to use a [python venv](https://docs.python.org/3/library/venv.html) and installing the requirements there to keep dependencies organized.
