 ...
 * {@link games.XArenaFuncs#competeNPlayer(controllers.PlayAgtVector, int, StateObservation, int, int, TSTimeStorage[], ArrayList, java.util.Random) XArenaFuncs.competeNPlayer()}.
 * <p>
