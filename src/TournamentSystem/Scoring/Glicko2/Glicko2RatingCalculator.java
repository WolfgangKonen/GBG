...
public class Glicko2RatingCalculator implements Serializable {
	 ...
	 * @param results
	 */
	public void updateRatings(Glicko2RatingPeriodResults results) {
	 ...
	 * @param results
	 */
	private void calculateNewRating(Glicko2Rating player, List<Glicko2Result> results) {
		...
		// note that the newly calculated rating values are stored in a "working" area in the Glicko2Rating object
	 ...
	 * @return
	 */
	private double v(Glicko2Rating player, List<Glicko2Result> results) {
		double v = 0.0;
	 ...
	 * @return delta
	 */
	private double delta(Glicko2Rating player, List<Glicko2Result> results) {
	 ...
	 */
	private double outcomeBasedRating(Glicko2Rating player, List<Glicko2Result> results) {
