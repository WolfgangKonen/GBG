...
public class StateObserver2048 implements StateObservation {
   ...
   private void evaluateBoard() {
	...
	public int[][] symmetryVectors(int[] boardVector) {
		// TODO
		throw new RuntimeException("StateObserver2048.symmetryVectors() not yet implemented");
	}
	...
	public int[][] fixedNTuples() {
		// TODO
		throw new RuntimeException("StateObserver2048.fixedNTuples() not yet implemented");
	}
	//
