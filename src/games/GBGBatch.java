...
public class GBGBatch { //extends ArenaTrain {
	 ...
	 *          [1] "1" or "2" to call either {@link #batch1(int, int, XArenaButtons, GameBoard) batch1} or {@link #batch2(int, int, XArenaButtons, GameBoard) batch2} <br>
	 ...
	 *          [4] (optional) maxGameNum: maximum number of training games (default -1) 
	 *          	
	 * @throws IOException 
	 */
