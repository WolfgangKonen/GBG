...
public class ArenaEWS extends Arena {
    public ArenaEWS(String title, boolean withUI){super(title,withUI);}
    ...
    public static void main(String[] args) {
        ArenaEWS t_Frame = new ArenaEWS("General Board Game Playing",true);
        if(args.length == 0) {
            t_Frame.init();
