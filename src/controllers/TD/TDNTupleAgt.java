...
//	private double[][] m_deltaTable = null;
	...
	/**
	 * Construct new {@link TDNTupleAgt}, setting everything from tdPar and set default
	 * maxGameNum=1000
	 * 
	 * @param tdPar
	 */
	public TDNTupleAgt(String name, TDParams tdPar, Feature feature) {
		super(name);
		initNet(tdPar, feature, 1000);
	}

	/**
	 * Construct new {@link TDNTupleAgt}, setting everything from tdPar and from maxGameNum
	 * 
	 * @param tdPar
	 * @param maxGameNum
	 */
	public TDNTupleAgt(String name, TDParams tdPar, Feature feature, int maxGameNum) {
		super(name);
