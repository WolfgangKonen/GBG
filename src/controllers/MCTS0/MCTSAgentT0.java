 ...
 */
public class MCTSAgentT0 extends AgentBase implements PlayAgent, Serializable 
{ 
     ...
     */
    private SingleMCTSPlayer0 mctsPlayer;
     ...
     */
    public MCTSAgentT0(String name,StateObservation so) //, ElapsedCpuTimer elapsedTimer)
    {
    	super(name);
...
//    }
    public MCTSAgentT0(String name,StateObservation so, ParMCTS parMCTS) //, ElapsedCpuTimer elapsedTimer)
    {
    	super(name);
    	initMCTSAgent(so, parMCTS, new ParOther());
    }
    
    public MCTSAgentT0(String name,StateObservation so, ParMCTS parMCTS, ParOther oPar) //, ElapsedCpuTimer elapsedTimer)
    {
    	super(name);
    ...
    private void initMCTSAgent(StateObservation so, ParMCTS parMCTS, ParOther oPar) {    	
        //Create the player.
        mctsPlayer = new SingleMCTSPlayer0(new Random(),parMCTS);		
