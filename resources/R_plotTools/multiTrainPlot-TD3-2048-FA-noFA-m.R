...
evalStr = ifelse(USEEVALT,"eval TDRefer","eval score")
evalStr = ifelse(MAPWINRATE,"win rate", evalStr)
path <- "../../agents/2048/csv/"; 
Ylimits=c(0,175000); errWidth=5000/wfac;
Xlimits=c(0,200); #  (-/+10 to grab position-dodge-moved points)
...
filenames=c(#"TCL3-fixed6_250k-lam05_P4_H001-FAm.csv"
           ...
           #,"TCL3-fixed6_250k-lam05_P4_H001-diff1-noFAm.csv"  
            "TC-NT3_fixed_4_6-Tupels_200k-FA.csv"
           ,"TC-NT3_fixed_4_6-Tupels_200k-noFA.csv"
           )
# evalQ is Score (19), evalT is off (-1),
...
qeval <- ifelse(length(grep("-ALm",filename)==1),"score","score")
