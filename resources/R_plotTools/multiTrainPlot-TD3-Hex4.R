...
filenames=c("multiTrainSarsa-eps02.csv"
           ,"multiTrainTD3-eps02.csv"
           #,"multiTrainTD3-NoLearnRM.csv"
           #,"multiTrainTD2-10-6-lam00.csv"
           ,"multiTrainTD2-10-6-eps02.csv"
           #,"multiTrainTD2-20-5-lam00.csv"
           ,"multiTrainTD3-NoFinalAdapt.csv"
           )
...
for (k in 1:length(filenames)) {
  ...
  lambdaCol = switch(k
                    ...
                    ,rep("TDNT3, no f.a.",nrow(df))   # no finalAdaptAgents
  )
  #browser()
