...
filenames=c("multiTrain_TCL-EXP-al20-lam05-500k-HOR001.csv"
           ...
           ,"multiTrain_TCL-EXP-al20-lam05-500k-HOR001-TERNARY.csv"
           ...
           #,"multiTrain_TCL-EXP-al20-lam05-500k-HOR001-TERNA-RES.csv"
           #,"multiTrain_TCL-EXP-al20-lam05-500k-HOR010.csv"
           #,"multiTrain_TCL-EXP-al20-lam05-500k-HOR001-RESET.csv"
...
for (k in 1:length(filenames)) {
  ...
  #browser()
  dfBoth <- rbind(dfBoth,cbind(df,lambda=lambdaCol,evalMode=evalModeCol))
...
tgc1 <- summarySE(dfBoth, measurevar="evalQ", groupvars=c(gamesVar,"lambda","evalMode"))
...
if (USEGAMESK) {
  ...
  q <- q + xlab(bquote(paste("games [*",10^3,"]", sep="")))
} else {
