#
# **** These are Jan'2023 results with TDNTuple4Agt on Othello. 
#      TCL-wrap: 20 wrapped agents   
#         TCL4-100_7_250k-lam05_P4_H010-FAm-stub.agt.zip with *=0,1,...,19
...
filenames=c("multiOthello-Fig04.csv",
            "multiOthello-Fig04-MCTS.csv"
            # both generated with experim_Fig04.sh
)
pdffile="MCTSWrap-TCL20.Jan23.pdf"
...
dfAll[grep("MCTS",dfAll$agtFile),c("agentGroup")] <- "MCTS-10k"
